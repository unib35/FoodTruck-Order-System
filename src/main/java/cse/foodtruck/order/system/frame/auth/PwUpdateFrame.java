...
public class PwUpdateFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        newPwCheckField = new javax.swing.JTextField();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PwUpdateFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PwUpdateFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField newPwCheckField;
