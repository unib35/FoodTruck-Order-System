...
public class refundCompleteFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form refundCompleteFrame
     */
    public refundCompleteFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(refundCompleteFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new refundCompleteFrame().setVisible(true);
            }
        });
    }
